...
def cal_eiou(box1:torch.Tensor, box2:torch.Tensor, enclosing_type:str="smallest"):
    """calculate eiou loss
    ...
    w_offset = box1[...,2] - box2[..., 2]
    h_offset = box1[...,3] - box2[..., 3]
    d2 = x_offset*x_offset + y_offset*y_offset
    w2_offset = w_offset*w_offset
    h2_offset = h_offset*h_offset
    eiou_loss = 1. - iou + d2/c2 + w2_offset/w2+h2_offset/h2
