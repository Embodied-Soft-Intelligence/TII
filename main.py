...
def get_args_parser():
    ...
    # parser.add_argument('--modelname', '-m', default='dab_detr', type=str, choices=['dab_detr', 'dab_deformable_detr'])
    parser.add_argument('--frozen_weights', type=str, default=None,
                        help="Path to the pretrained model. If set, only the mask head will be trained")
    parser.add_argument('--ref_5d', default= False, type=bool)
    parser.add_argument('--bbox_embed_diff_each_layer_grasp', default=False, type=bool)
    # parser.add_argument('--iter_adj', default=False, type=bool)
    parser.add_argument('--iter_adj', default=True, type=bool)
    ...
    parser.add_argument('--return_interm_indices', default=[1,2,3],
    ...
    # * Matcher for grasp
    parser.add_argument('--set_cost_grasp_class', default=2, type=float,
                        help="Class coefficient in the matching cost")
    # parser.add_argument('--set_cost_grasp', default=5, type=float,
    #                     help="giou box coefficient in the matching cost")
    parser.add_argument('--set_cost_grasp_angle', default=1, type=float,
                        help="giou box coefficient in the matching cost")
    parser.add_argument('--set_cost_grasp_box', default=2, type=float,
                        help="giou box coefficient in the matching cost")
    parser.add_argument('--set_cost_grasp_iou', default=2, type=float,
                        help="giou box coefficient in the matching cost")
    ...
    parser.add_argument('--grasp_ious_loss_coef', default=4, type=float)
    parser.add_argument('--grasp_ce_loss_coef', default=1, type=float)
    parser.add_argument('--grasp_angle_loss_coef', default=2, type=float)
    parser.add_argument('--grasp_box_loss_coef', default=6, type=float)
    ...
    parser.add_argument('--pred_train_dir', default=r'/home/root123/code/D2TriPO_DETR/resnet101_doubledetr.pth')
    parser.add_argument('--pred_train', default=True, type=bool)
